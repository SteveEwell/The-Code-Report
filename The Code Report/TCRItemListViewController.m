...
@implementation TCRItemListViewController
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Item" inManagedObjectContext:[appDelegate.persistentStack managedObjectContext]];
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"itemNumber" ascending:NO];
...
- (void)insertNewItem:(id)sender {
    ...
    [newManagedObject setValue:[self randomItemNumber] forKey:@"itemNumber"];
    [newManagedObject setValue:[self randomItemName] forKey:@"itemDescription"];
    [newManagedObject setValue:@NO forKey:@"pendingDelete"];
...
-(NSNumber *)randomItemNumber {
    int i = arc4random_uniform(9999999);
    NSNumber *n = [NSNumber numberWithInt:i];
    return n;
}

-(NSString *)randomItemName {
    int i = arc4random_uniform(999);
    NSString *s = [NSString stringWithFormat:@"Item %i", i];
    return s;
}
