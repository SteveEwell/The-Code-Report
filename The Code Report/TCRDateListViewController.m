...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    TCRDateOM *date = [self sortedDates][indexPath.row];
    cell.textLabel.text = [NSString stringWithString:[NSDateFormatter localizedStringFromDate:date.expDate dateStyle:NSDateFormatterShortStyle timeStyle:NSDateFormatterFullStyle]];
}
...
- (void)insertNewObject:(id)sender {
    ...
    TCRDateOM *newManagedObject = [[self.item.itemExpDates]];
